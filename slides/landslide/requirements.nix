...
let
  ...
  generated = self: {
    ...
    "landslide" = python.mkDerivation {
      name = "landslide-1.1.6";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/c9/7d/56b98d01d8094e9d23a4720a432c5ed4d76b19e6da2e8e3f1419b5e4f39e/landslide-1.1.6.tar.gz";
        sha256 = "93eb108768c6139896ee34ef0649d0daf8248f180b9f81962aa992311ab0a09a";
};
      doCheck = commonDoCheck;
      format = "setuptools";
      buildInputs = commonBuildInputs ++ [ ];
